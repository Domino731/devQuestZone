...
import {getLangBgColor, getLangHeaderTextColor, getlangText} from "../../../../utils/lang.ts";
 ...
 * */
export const CodeSnippet = ({code, lang, className}: CodeSnippetProps) => {
    ...
    return (
        <div className={`${styles.container} ${className}`}>
            <Box sx={{backgroundColor: getLangBgColor(lang)}} className={styles.header}>
