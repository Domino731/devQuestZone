...
export const Answer = ({answer}: { answer: QuestionAnswer }) => {
    return <Box sx={answerStyles}>
        ...
        {/*        <span class="text-white">1.1 - </span> Open your web browser (such as Chrome, Firefox, or Safari).<br/>*/}
        ...
        {/*    </div>*/}
        {/*    <CodeSnippet code={code} lang="html"/>*/}
        ...
        {/*        <span class="text-white">3.3 - </span> Open a terminal and navigate to the directory containing your*/}
        {/*        JavaScript file.<br/>*/}
        {/*        <span class="text-white">3.4 - </span> Run the script using the <code>node.js</code> command: <code>node*/}
        {/*        app.js</code>*/}
        {/*    </div>*/}
